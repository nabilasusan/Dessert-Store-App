<nav x-data="{ open: false }" class="bg-white/80 backdrop-blur border-b border-gray-100 shadow-sm">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center gap-3">
                ...
                <!-- Logo Icon -->
                <div class="h-10 w-10 rounded-xl bg-rose-100 flex items-center justify-center shadow-sm">
            ...
            <div class="hidden sm:flex sm:items-center">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-xl shadow-sm ring-1 ring-gray-200 text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
